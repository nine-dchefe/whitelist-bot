...
const Discord = require("discord.js"); // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7
const client = new Discord.Client({intents: 32767,}); // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7 // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7
const config = require("./config.json") 
const mysql = require('mysql'); // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7 
...
.setTitle("INICIE SUA WL:")
  .setDescription('Para iniciar sua wl basta clicar em "🔰"'); // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7
    const iniciar = new Discord.MessageActionRow().addComponents(
        ...
        ); // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7
        client.channels.cache.get(canalwl).bulkDelete("100")
    
    
        client.channels.cache.get(canalwl).send({embeds: [embed], components: [iniciar]})
})
  client.login(config.token); // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7
        ...
        if (interaction.isButton()) {
            ...
            if (interaction.customId.startsWith('wl')) {
               ...
               let enviarresultado = client.channels.cache.get(resultadog)
                ...
                const host = "ID"; // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7
                let title = server.name
                let color = "BLUE"
                var exp = 0; // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7
                let pts = "8"
                const userdb = "NAME_USER"; // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7 // MYSQL USUÁRIO
                const senhadb = "SENHA_USER"; // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7 // MYSQL SENHA
                const basedb = "NAME_DATABASE"; // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7 // MYSQL DB
    ...
    let guild = interaction.guild; // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7  
      ...
      if(i1 == 0) {
        ...
        msg.delete()
            ...
            .on('collect', c => {
              ...
              if(!c.author.id == interaction.user.id) return; // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7
    ...
    if(i2 == 0) {
                  ...
                  msg.delete()
                      ...
                      .on('collect', c => {
                        ...
                        if(c.author.id == interaction.user.id) {
                          ...
                          let pp3 = c.content
                          if(pp3 == "2") { 
                            exp += 1; // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7
                          }
                                                                  ...
                                                                  if(c.author.id == interaction.user.id) {
                                                                    ...
                                                                    let enviar = channel.send({embeds: [ok] }).then(msg => {
                                                                      ...
                                                                      setTimeout(() => {
                                                                        ...
                                                                        channel.delete("Wl finalizada!"); // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7
                                                                    ...
                                                                    if(pts <= exp) {
                                                                      ...
                                                                      setInterval(function () {
                                                                        connection.query('SELECT 1'); // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7
                                                                      }, 5000); // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7
      ...
      process.on('unhandledRejection', (reason, p) => {
        console.log(' [ ANTICLASH ] | SCRIPT REJEITADO'); // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7
        console.log(reason, p); // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7
    }); // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7



    process.on("uncaughtException", (err, origin) => {
        console.log(' [ ANTICLASH] | CATCH ERROR'); // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7
        console.log(err, origin); // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7
    }) 



    process.on('uncaughtExceptionMonitor', (err, origin) => {
        console.log(' [ ANTICLASH ] | BLOQUEADO'); // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7
        console.log(err, origin); // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7
    }); // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7


    process.on('multipleResolves', (type, promise, reason) => {
        console.log(' [ ANTICLASH ] | VÁRIOS ERROS'); // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7
        console.log(type, promise, reason); // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7
    }); // DISCORD DO DONO DO BOT: https://discord.gg/TJ3tVnemq7